...
class TestSingleColumnTwoQubitNeighbouringGate(TestQiskit):
    ...
    def test_dirac_state_little_endian(self):
        assert self.data[DIRAC_STATE_LITTLE_ENDIAN] == RESULTS_SINGLE_COLUMN_TWO_QUBIT_NEIGHBOURING_GATE[DIRAC_STATE_LITTLE_ENDIAN]

    def test_dirac_state_big_endian(self):
        assert self.data[DIRAC_STATE_BIG_ENDIAN] == RESULTS_SINGLE_COLUMN_TWO_QUBIT_NEIGHBOURING_GATE[DIRAC_STATE_BIG_ENDIAN]
    ...
    def test_matrix_state_little_endian(self):
        assert self.data[MATRIX_STATE_LITTLE_ENDIAN] == RESULTS_SINGLE_COLUMN_TWO_QUBIT_NEIGHBOURING_GATE[MATRIX_STATE_LITTLE_ENDIAN]

    def test_matrix_state_big_endian(self):
        assert self.data[MATRIX_STATE_BIG_ENDIAN] == RESULTS_SINGLE_COLUMN_TWO_QUBIT_NEIGHBOURING_GATE[MATRIX_STATE_BIG_ENDIAN]
